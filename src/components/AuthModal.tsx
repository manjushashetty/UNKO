        ...
        {user && !user.isAnonymous ? (
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              type="button"
              disabled={loading}
              className="w-full py-2.5 px-4 rounded-xl bg-[#240D16] hover:bg-[#3A1422] border border-[#6E1835] text-[#F8FAFC] font-medium text-sm flex items-center justify-center gap-3 transition-all hover:border-[#22D3EE]/50 hover:shadow-[0_0_15px_rgba(34,211,238,0.15)] disabled:opacity-50 disabled:cursor-not-allowed"
            >
